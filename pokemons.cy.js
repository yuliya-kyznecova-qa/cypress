describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[type="email"]').type('63@yandex.ru');                   // вводим логин
         cy.get('input[type="password"]').type('u00279');               // вводим пароль
         ...
         cy.get('.k_input_name').type('кошка боня');                           // вводим имя владельца действия карты
